...
import * as ReactHighcharts from 'react-highcharts/ReactHighstock';
import { AxisLabels } from 'highcharts';
...
class HighChartComponent extends React.Component<IProps,ISate>{
    ...
    render() {
        ...
        return (
            <div>
                <h1>HIGH CHART 2</h1>
                {this.state.chartData.length > 0 ? <ReactHighcharts config = {chartConfig}></ReactHighcharts>:<h1>Loading...</h1>}
            </div>
        );
    }
}
